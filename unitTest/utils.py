...
def load_models():
    model_lstm = cavermodel.CaverModel(
        "/data_hdd/caver_models/checkpoints_char_lstm", device="cpu"
    )
    model_cnn = cavermodel.CaverModel(
        "/data_hdd/caver_models/checkpoints_char_cnn", device="cpu"
    )
